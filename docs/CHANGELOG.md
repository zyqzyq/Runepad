...
记录 `AGENTS.md` 与 `docs/` 结构的变更。应用代码变更请使用 Git 提交历史。

| 版本 | 日期 | 主要变更 |
|------|------|----------|
| 0.6.0 | 2026-05-26 | 更新应用、Tauri、Rust crate 与文档发布元数据至 `0.6.0`。 |
...
| 0.3.0 | 2026-05-19 | 更新项目实际阶段（P0/P1 完成，P2/P3+ 部分完成）；补充 i18n、settings、recent files、close tab、explorer stores；补充错误处理标准、已知问题、图标生成命令；更新目录结构和依赖清单为「已安装」状态 |
| 0.2.2 | 2026-05-18 | 补充 Tailwind v4、shadcn/ui v4、CodeMirror 6 集成规范；定义 IPC / Store / UI 契约 |
| 0.1.0 | earlier | 初始版本，项目脚手架定义 |
